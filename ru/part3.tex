...
\frametitle{\insertsection: Упражнение}
\vspace{-2ex}
Воссоздайте замечательную <<Презентацию о Геттисберге>> Питера Норвига в
...
\begin{center}
\filhref{beamer-exercise-solution.pdf}{Щёлкните, чтобы открыть образец для
сравнения}
\end{center}
\item Когда попробуете, \ovlhref{beamer-exercise-solution.tex}{щёлкните, чтобы
  посмотреть решение}.
\end{enumerate}
\vspace{1ex}
\end{frame}
...
\scalebox{0.33}{\input{escher-brick-penrose-triangle}}}%
\hspace*{-3mm}%
